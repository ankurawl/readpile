"""Tests for mediakit.mcp_server — MCP tool functions."""
...
from mediakit.mcp_server import mcp
...
class TestCrawlModeDetection:
    def test_rss_mode(self):
        from mediakit.cli.crawl import _detect_crawl_mode
